...
namespace SmartMetroService.Storage.Migrations
{
    ...
    [Migration("20260916134833_Update_Journey_table")]
    partial class Update_Journey_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartMetroService.Domain.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartMetroService.Domain.Entities.RapidPass", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartMetroService.Domain.Entities.UserWallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartMetroService.Domain.Entities.Journey", b =>
                {
                    ...
                    b.HasOne("SmartMetroService.Domain.Entities.RapidPass", "RapidPass")
                        .WithMany()
                        .HasForeignKey("RapidPassId")
